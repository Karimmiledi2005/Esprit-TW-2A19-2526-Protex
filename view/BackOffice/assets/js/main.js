    ...
    if (bellBtn) {
        ...
        notifPanel.innerHTML = `
            ...
            <div class="notif-footer">
                <a href="${(window.BASE_URL || '')}/view/BackOffice/sinsiter.php">Accéder à tous les sinistres</a>
            </div>
        `;
        ...
        async function updateNotifications() {
            try {
                const res = await fetch((window.BASE_URL || '') + '/view/BackOffice/get_notifications.php');
        ...
        function renderList(notifications) {
            ...
            if (notifications && notifications.length > 0) {
                list.innerHTML = notifications.map(item => `
                    <a href="${(window.BASE_URL || '')}/view/BackOffice/sinsiter.php" class="notif-item">
        ...
        async function markAsRead() {
            try {
                await fetch((window.BASE_URL || '') + '/view/BackOffice/mark_notifications_read.php');
                dot.style.display = 'none';
            } catch (e) {}
        }
