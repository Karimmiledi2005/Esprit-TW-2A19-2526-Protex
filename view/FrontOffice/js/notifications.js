...
const NOTIF_API = 'get_notifications.php';
const NOTIF_MARK_ALL_API = 'mark_all_notifications_read.php';
...
// Auto-init fallback
if (typeof window !== 'undefined' && window._notifUserId) {
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', () => initNotifications(window._notifUserId));
    } else {
